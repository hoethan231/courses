...
REM
REM Generated by Vivado on Wed Sep 10 10:49:49 -0700 2025
...
echo "xvlog --incr --relax -prj tb_factorial_program_vlog.prj"
call xvlog  --incr --relax -prj tb_factorial_program_vlog.prj -log xvlog.log
