...
HD_PWD='C:/Users/Admin/OneDrive/Desktop/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log something.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source something.tcl
