...
HD_PWD='C:/Users/Admin/OneDrive/Desktop/Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log something.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source something.tcl -notrace
